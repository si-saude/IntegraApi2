...
@Path("clinica")
@RequestInterceptor
public class ClinicaService extends GenericService<Clinica,ClinicaFilter,ClinicaBo> {
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Path("/list")
	public Response getList(ClinicaFilter filter) {		
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Path("/selectList")
	public Response getSelectList(ClinicaFilter filter) {		
